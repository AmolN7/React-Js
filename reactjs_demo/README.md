...
#Ract js requiremnts and basic commands
...
- Ptoject Command
    ...
    #Create project build (Bundles the app into static files for production)
    $ npm run build
...
- Create mock server for api testing
    ...
    #run jeson server
    $ json0server db.json --port 3001

- To make http calls install Axios 
    $ npm install axios
